...
Deno.test('isOlderThan should return true if the difference between the dates is greater than the specified hours', () => {
...
Deno.test('isOlderThan should return false if the difference between the dates is less than the specified hours', () => {
...
Deno.test('isOlderThan should handle invalid RCF822 dates and return false', () => {
...
Deno.test('pagination returns correct object when page and count are provided', () => {
  const page = 2;
  const count = 10;
...
Deno.test('pagination returns correct object when only count is provided', () => {
  const count = 5;
